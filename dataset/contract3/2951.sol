...
emit Withdrew(msg.sender, ethToBeClaimed.div(quarter1));
...
emit Withdrew(msg.sender, ethToBeClaimed.div(quarter2));
...
emit Withdrew(msg.sender, ethToBeClaimed.div(quarter3));
