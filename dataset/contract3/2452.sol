...
emit WithdrewTokens(thisContractAddress, admin, (tokensToBeClaimed.div(quarter1)));
...
emit WithdrewTokens(thisContractAddress, admin, (tokensToBeClaimed.div(quarter2)));
...
emit WithdrewTokens(thisContractAddress, admin, (tokensToBeClaimed.div(quarter3)));
...
emit WithdrewTokens(thisContractAddress, admin, (thisContractTokenBalance()));
}
