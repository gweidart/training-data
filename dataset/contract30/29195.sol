...
uint256 private constant PRIVATE_SUPPLY              = INITIAL_SUPPLY * 30 / 100;
uint256 private constant RESERVED_FOR_TEAM            = INITIAL_SUPPLY * 10 / 100;
uint256 private constant COMMERCIAL_PLAN             = INITIAL_SUPPLY * 20 / 100;
uint256 private constant RESERVED_FOR_FOUNDATION     = INITIAL_SUPPLY * 15 / 100;
uint256 private constant COMMUNITY_REWARDS	     	= INITIAL_SUPPLY * 25 / 100;
uint256 private constant PRIVATE_SUPPLY_VESTING       = PRIVATE_SUPPLY * 50 / 100;
struct VestingGrant {
address beneficiary;
uint256 start;
uint256 duration;
...
address public constant PRIVATE_SUPPLY_ADDRESS = 0xd509bE99995A24e089C9789ed69B08031F830615;
VestingGrant privsteSupplyVestingGrant;
address public constant TEAM_ADDRESS = 0x9C99b03224122b419a84a6bD7A609f7288d65Eb9;
