...
uint public constant MIN_CAP = 50000000000;
uint public constant MAX_CAP = 700000000000;
uint public constant MIN_INVEST_ETHER = 100 finney;
uint private constant CROWDSALE_PERIOD = 5 days;
uint public constant COIN_PER_ETHER = 9000000000;
NewHope public coin;
...
if (now < startTime.add(1 days)) return amount.add(amount.div(2));
return amount;
}
