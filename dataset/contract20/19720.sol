...
stages.createStage(1, startTime.add(1 days), 10000000000, 10000000, 175000000000);
stages.createStage(2, startTime.add(2 days), 11000000000, 5000000, 300000000000);
stages.createStage(3, startTime.add(3 days), 12000000000, 2500000, 575000000000);
