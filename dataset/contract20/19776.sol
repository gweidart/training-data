...
uint16[9] memory param1 = [10001, 5, 9, 400, 0, 0, 0, 0, 1];
...
uint16[9] memory param2 = [10002, 5, 9, 0, 60, 60, 0, 0, 1];
...
require(msg.value >= 0.99 ether);
payBack = (msg.value - 0.99 ether);
uint16[9] memory param4 = [10004, 5, 9, 0, 0, 0, 0, 3, 1];
tokenContract.createFashion(msg.sender, param4);
buyArray.push(10004);
} else {
require(msg.value >= 0.99 ether);
payBack = (msg.value - 0.99 ether);
uint16[9] memory param5 = [10005, 5, 9, 200, 20, 20, 20, 0, 1];
