...
if (battleboardData.getTileIDbyPosition(battleboardId, _position) != 0 ) {revert();}
if (numBarriers >= numBarriersPerBoard) {revert();}
if (msg.value < barrierPrice) {revert();}
if ((_barrierType <2) || (_barrierType >4)) {revert();}
