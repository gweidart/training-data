...
uint public totalSupply = 18000000 * (10 ** uint(decimals));
uint public poolInvestors = 3000000 * (10 ** uint(decimals));
uint public poolBounty = 150000 * (10 ** uint(decimals));
uint public poolPresale = 700000 * (10 ** uint(decimals));
uint public poolSale = 14150000 * (10 ** uint(decimals));
uint public ownerInitialBalance = 3850000 * (10 ** uint(decimals));
...
require(safeAdd(StatsSold, tokensToAdd) <= poolSale);
