...
loanManager.addLoanProduct(30 days, 987821, 600000, 800, 50000, true);
loanManager.addLoanProduct(14 days, 994279, 600000, 800, 50000, true);
loanManager.addLoanProduct(7 days, 997132, 600000, 800, 50000, true);
locker.setLockProductActiveState(0, false);
locker.setLockProductActiveState(1, false);
locker.setLockProductActiveState(2, false);
locker.addLockProduct(8220, 30 days, 1000, true);
locker.addLockProduct(3836, 14 days, 1000, true);
locker.addLockProduct(1918, 7 days, 1000, true);
}
}
