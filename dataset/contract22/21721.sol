...
uint public EXPECTED_START = 1521846420;
uint public EXPECTED_END = 1521855420;
...
statusQuery = makeOraclizeQuery(delay, "URL", "json(https:
}
...
team0Query = makeOraclizeQuery(0, "URL", "json(https:
}
else {
...
team1Query = makeOraclizeQuery(0, "URL", "json(https:
}
