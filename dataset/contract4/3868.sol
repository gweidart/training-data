...
9000000000 * (10 ** uint256(decimals));
uint256 public constant CROWDSALE_ALLOWANCE =
6000000000 * (10 ** uint256(decimals));
uint256 public constant ADMIN_ALLOWANCE =
...
address(0x0),
msg.sender,
totalSupply_.sub(adminAllowance)
);
...
require(
(tokensTransferred[msg.sender].add(_value)).mul(2) <=
balances[msg.sender].add(tokensTransferred[msg.sender])
);
tokensTransferred[msg.sender] = tokensTransferred[msg.sender].add(
_value
);
