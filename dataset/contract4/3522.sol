...
PlayerBookInterface(0xb57371379e8BF49d3c0a8A07638E429386A636A4);
address private admin = msg.sender;
string public constant name = "FOMO Lightning";
string public constant symbol = "LTNG";
uint256 private rndExtra_ = 15 minutes;
uint256 private rndGap_ = 15 minutes;
uint256 private constant rndInit_ = 15 minutes;
uint256 private constant rndInc_ = 10 seconds;
uint256 private constant rndMax_ = 30 minutes;
...
plyrRnds_[_pID][_rID].eth.add(_eth) > 2100000000000000000
) {
uint256 _availableLimit = (2100000000000000000).sub(
plyrRnds_[_pID][_rID].eth
);
