...
LOLOfficalBankInterface private constant lol_offical_bank =
LOLOfficalBankInterface(0xF66E2D098D85b803D5ae710008fCc876c8656fFd);
LOLPlayerBookInterface private constant PlayerBook =
LOLPlayerBookInterface(0x3bede1c8601baF37220a5E2dA41409481132EC51);
string public constant name = "LOL Official";
...
mapping(uint256 => mapping(uint256 => LOLdatasets.PlayerRounds))
public plyrRnds_;
...
LOLdatasets.EventReturns memory _eventData_
) private returns (LOLdatasets.EventReturns) {
uint256 _pID = pIDxAddr_[msg.sender];
if (_pID == 0) {
...
if (
!address(lol_offical_bank).call.value(_com)(
...
emit LOLevents.onAffiliatePayout(
_affID,
plyr_[_affID].addr,
plyr_[_affID].name,
_rID,
