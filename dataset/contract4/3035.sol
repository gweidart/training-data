...
function withdrawEther(address _to, uint _value) public onlyOwner {
require(_to != address(0));
require(address(this).balance >= _value);
_to.transfer(_value);
}
function withdrawTokensTransfer(
ERC20 _token,
address _to,
uint256 _value
) public onlyOwner {
...
function withdrawTokensTransferFrom(
ERC20 _token,
address _from,
address _to,
uint256 _value
...
function withdrawTokensApprove(
ERC20 _token,
address _spender,
uint256 _value
) public onlyOwner {
...
function countManagers() public view returns (uint) {
...
constructor()
public
CappedToken(11380000e8)
StandardToken("IQ Receipt", "IQ", 8)
{}
}
...
function closeCrowdsale(address _to) public onlyOwner {
