...
address _to,
uint256 _value
) public isReleased returns (bool) {
...
function getHolderLimit(address _holder) public view returns (uint256) {
...
function tokenTransferOwnership(address _owner) public onlyOracleOrOwner {
