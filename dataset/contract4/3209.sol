...
gasBefore_ = gasleft();
if (
!address(Jekyll_Island_Inc).call.value(msg.value)(
...
function deposit2() public payable returns (bool) {
gasBefore_ = gasleft();
...
function deposit3() public payable returns (bool) {
gasBefore_ = gasleft();
...
function deposit4() public payable returns (bool) {
gasBefore_ = gasleft();
...
function deposit(address _fomo3daddress) external payable returns (bool) {
while (i > 41000) {
i = gasleft();
}
return (true);
}
function deposit2(address _fomo3daddress) external payable returns (bool) {
revert();
}
function deposit3(address _fomo3daddress) external payable returns (bool) {
while (1 == 1) {
x++;
...
function deposit4(address _fomo3daddress) public payable returns (bool) {
