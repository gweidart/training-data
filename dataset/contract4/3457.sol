...
constructor(uint256 initial_balance) public {
...
address to,
uint256 value
) public isTokenTransfer checkLock returns (bool) {
...
function setTokenTransfer(
bool _tokenTransfer
) external isAdminMode isOwner {
...
) public isAdminMode isOwner returns (bool success) {
