...
function addAmbassador(address _ambassador) public onlyAdministrator {
...
address _ambassador
) public view onlyAdministrator returns (bool) {
...
address _referredBy
) internal isActivated antiEarlyWhale(_incomingEthereum) returns (uint256) {
address _customerAddress = msg.sender;
