...
* @dev ERC-721 non-fungible token standard. See https:
interface ERC721 {
...
* @dev ERC-721 interface for accepting safe transfers. See https:
...
* @dev A standard for detecting smart contract interfaces. See https:
interface ERC165 {
