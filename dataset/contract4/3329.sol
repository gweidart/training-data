...
function TokenCappedCrowdsale(
uint256 _tokenPresaleCap,
...
{
using SafeMath for uint256;
uint256 public constant RESERVE_AMOUNT = 70000000 * 10 ** 18;
uint256 public constant MIN_INVESTMENT = 0.1 * 10 ** 18;
