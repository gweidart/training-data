...
event FrozenAccountToken(
address target,
uint256 amount,
uint256 unforzenDate
);
function DefensorWallet(
...
require(
balances[msg.sender] - value >= frozenTokens[msg.sender].amount
);
}
