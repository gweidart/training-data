...
JIincForwarderInterface(0x84AB3c7f95E664223b871Ec2b4FA37E39f1B1F40);
TeamJustInterface private constant TeamJust =
TeamJustInterface(0x4D499E43eadbab98b8995F473163dAca0Fd8ac3a);
MSFun.Data private msData;
function multiSigDev(bytes32 _whatFunction) private returns (bool) {
return (
MSFun.multiSig(
msData,
TeamJust.requiredDevSignatures(),
_whatFunction
)
);
}
...
) public view onlyDevs returns (bytes32, uint256) {
return (
