...
address _user
) public isController returns (bool) {
...
address _to,
uint256 _amount
) public isOwner canMint returns (bool) {
...
function finishMinting() public isOwner canMint returns (bool) {
