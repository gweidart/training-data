...
constructor(address cfoAddr) public BobbyERC20Base(cfoAddr) {
...
_balancesMap[_to].unlockPeriod = _duration.mul(30).mul(1 days).div(
_periods
);
...
public
view
returns (uint256 unlocked, uint256 unit, uint256 period, uint256 last)
{
